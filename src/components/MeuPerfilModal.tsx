...
export function MeuPerfilModal({
  ...
  return (
    ...
    >
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto bg-[#F7F5FB] border-[#DCDDE3]">
        <DialogHeader className="pb-4 border-b border-[#DCDDE3]">
          <div className="flex items-center gap-2">
            <div className="w-8 h-8 rounded-full bg-[#5B2E8C] text-white flex items-center justify-center font-bold text-sm">
              {nome.charAt(0)}
            </div>
            <div>
