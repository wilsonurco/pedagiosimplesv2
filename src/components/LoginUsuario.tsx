          ...
          <Card className="shadow-lg border border-[#F8F9FA] rounded-lg">
            <CardHeader className="text-center pb-6">
              <CardTitle className="text-2xl text-[#000000] flex items-center justify-center gap-3">
                <Lock className="h-6 w-6 text-[#003566]" />
                Login
              </CardTitle>
            </CardHeader>
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      className={`text-lg py-3 pl-10 border-[#F8F9FA] focus:border-[#003566] focus:ring-[#003566] ${errors.cpf ? 'border-red-500' : ''}`}
                      maxLength={14}
                    />
                  </div>
                ...
                {/* Senha */}
                <div className="space-y-2">
                  <Label htmlFor="senha" className="text-[#000000]">Senha</Label>
                  <div className="relative">
                    ...
                    <Input
                      ...
                      className={`text-lg py-3 pl-10 pr-10 border-[#F8F9FA] focus:border-[#003566] focus:ring-[#003566] ${errors.senha ? 'border-red-500' : ''}`}
                    />
                    <button
                      type="button"
                      onClick={() => setShowPassword(!showPassword)}
                      className="absolute right-3 top-1/2 transform -translate-y-1/2 text-[#6C757D] hover:text-[#003566]"
                    >
                ...
                <div className="text-right">
                  <button 
                    type="button"
                    className="text-sm text-[#003566] hover:underline"
                ...
                <div className="pt-4">
                  <Button 
                    type="submit" 
                    size="lg" 
                    className="w-full bg-[#003566] hover:bg-[#002a52] text-white py-4 text-lg rounded-lg font-medium transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              ...
              <div className="relative my-6">
                <div className="absolute inset-0 flex items-center">
                  <span className="w-full border-t border-[#F8F9FA]" />
                </div>
              ...
              <div className="text-center">
                ...
                <Button 
                  variant="outline" 
                  size="lg" 
                  className="w-full py-4 text-lg border-[#003566] text-[#003566] hover:bg-[#F8F9FA] rounded-lg font-medium transition-colors"
                  onClick={onCadastrar}
                >
